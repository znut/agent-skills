...
// All config + tool output lives OUTSIDE the repo, under $AGENT_TOOLS_HOME
...
/** Every $AGENT_TOOLS_HOME/config/*.json, parsed. Used by the poller to poll every configured repo in one process. */
